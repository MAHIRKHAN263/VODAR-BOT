...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "shakib") || (event.body.toLowerCase() == "সাকিব")) {
   ...
   if ((event.body.toLowerCase() == "gd mr9") || (event.body.toLowerCase() == "good morning")) {
  ...
  if ((event.body.toLowerCase() == "mahir") || (event.body.toLowerCase() == "mashik mahir") || (event.body.toLowerCase() == "kire mahir") || (event.body.toLowerCase() == "মাহির")) {
   ...
   if ((event.body.toLowerCase() == "tor boss ke") || (event.body.toLowerCase() == "boss ke ")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami mahir") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "who are mahir") || (event.body.toLowerCase() == "মাহির কে")) {
   ...
   if ((event.body.toLowerCase() == "bot tor nam ki") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
